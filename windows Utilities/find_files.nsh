...
INPUT_FILE="/C/Utilities/blacklist.txt"

#Get the names of the files
BLACKLIST=""
cat "$INPUT_FILE" | while read FILE
do
	#echo "$FILE##"
	if [[ "$BLACKLIST" = "" ]]; then
		BLACKLIST="'$FILE'"
...
nexec -i $TARGET "C:\\Utilities\\findfiles.bat" "\"$BLACKLIST\"" | grep -v LogParser | sort > /C/tmp/out.txt
